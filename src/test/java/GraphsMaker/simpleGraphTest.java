...
public class simpleGraphTest {
	...
	private void setWeightByDate(String date,String UserMail,int weight) {
		...
		if (DailyInfoList.isEmpty())
			...
			try {
				FirebaseDatabase.getInstance().getReference().child(UserMail).child("Dates").child(date)
	...
	@Test
	public void enter(){
		String UserMail = "ororfeldman4@gmail.com".replace(".", "_dot_");
