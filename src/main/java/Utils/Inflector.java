/**this file is meant to deal with singularize and pluralize
 * of items.
 * its main target is to "noramlize" an item (turn it into singular form)
 * before it is searched in the USDA - in singular form it is easier to
 * check for the item (e.g., if the user gives the food in plural form,
 * the item may not be found)
 * 
 * ...
 * this should be credited for JBoss DNA for the original file.
 * @author Shaked Sapir
 * @since 2019-05-14*/
package Utils;
