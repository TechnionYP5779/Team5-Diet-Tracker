...
public class UserInfo {
	 ...
	 */
	public UserInfo(Gender gender, int age, int height, double dailyCaloriesGoal, double dailyProteinGramsGoal,
			double dailyCarbsGoal, double dailyFatsGoal, int dailyLimitCigarettes) {
		this.gender = gender;
		this.age = age;
		this.height = height;
	...
	public UserInfo(Gender gender, int age, int height, double dailyCaloriesGoal, double dailyProteinGramsGoal,
			double dailyCarbsGoal, double dailyFatsGoal, int dailyLimitCigarettes, int wg) {
		this.gender = gender;
		this.age = age;
		this.height = height;
		this.dailyCaloriesGoal = dailyCaloriesGoal;
	...
	public boolean equals(final Object o) {
		...
		return Double.compare(user.age, age) == 0 && Double.compare(user.height, height) == 0
